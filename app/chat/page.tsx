...
//       <div className="bg-green-100 border border-gray-300 rounded-lg p-4 w-full max-w-md flex flex-col h-full max-h-96">
...
export default function Chat() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <div className="bg-green-100 border border-gray-300 rounded-lg p-4 w-full max-w-md flex flex-col h-full max-h-96 mt-6">
        <div className="flex-grow overflow-y-auto mb-4">
          {messages.map((m) => (
            <div key={m.id} className="mb-2">
              <strong>{m.role === 'user' ? 'You: ' : 'AI: '}</strong>
